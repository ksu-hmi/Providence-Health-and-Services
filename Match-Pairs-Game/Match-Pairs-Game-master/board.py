...
ALL_COLORS = (RED, WHITE, BLUE, YELLOW, ORANGE, PINK, LIME)
ALL_SHAPES = (CIRCLE, SQUARE, DIAMOND, OVAL)
...
class Board:
    def __init__(self, DISPLAY_SURF, FPS_CLOCK):
        ...
        self.board_width = 8   #Number of boxes in a row
        self.board_height = 6   #Number of boxes in a column
        ...
        self.box_size = 45  #Dimensions of square box
        self.gap_size = 15  #Gap between boxes
        ...
        self.reveal_speed = 5    #Speed at which box is covered or revealed
    ...
    def drawIcon(self, shape, color, boxx, boxy):
        ...
        (circle, square, diamond, oval) = self.all_shapes

        if shape == circle:
              draw.circle(self.DISPLAY_SURF, color, (x+half, y+half), half)
              draw.circle(self.DISPLAY_SURF, color, (x+half, y+half), quarter)
